...
export function New() {
  ...
  async function handleCreateNewHabit() {
    try {
      ...
      console.log(err);
      return Alert.alert("Ops!", "Não foi possível criar novos hábitos");
    }
  }
  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      >
        ...
        <TextInput
          className="h-12 p-4 rounded-lg mt-3 bg-zinc-900
             text-white border-2 border-zinc-800 focus:border-green-600 mb-4"
